...
//         <AreaYearlyExpenseChart yearlyExpenseData={yearlyExpenseData} selectedYear={selectedYear} setSelectedYear={setSelectedYear} />
//         <HighLevelPieChart categoryData={categoryData} selectedYear={selectedYear} setSelectedYear={setSelectedYear} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth} />
//       </div>
//       <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
//         <NetBalanceChart netBalanceData={netBalanceData} selectedYear={selectedYear} setSelectedYear={setSelectedYear} />
//       </div>
//       <div className="grid grid-cols-1 lg:grid-cols-1 gap-6">
//         <TreeGraphChart treeData={treeData} />
//       </div>
//       <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
//         <MonthlyRadarChart yearlyExpenseData={yearlyExpenseData} selectedYear={selectedYear} setSelectedYear={setSelectedYear} />
//         <CategoryWiseExpenseChart selectedYear={selectedYear} setSelectedYear={setSelectedYear} />
//       </div>
//       <div className="grid grid-cols-1 lg:grid-cols-1 gap-6">
//         <DailyExpenseChart dailyExpenseData={dailyExpenseData} selectedYear={selectedYear} setSelectedYear={setSelectedYear} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth} />
//       </div>
//       <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
//         <AdvancedPolarChart dailyExpenseData={dailyExpenseData} selectedYear={selectedYear} setSelectedYear={setSelectedYear} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth} />
//         <GaugeMultipleKPIChart categoryData={categoryData} selectedYear={selectedYear} setSelectedYear={setSelectedYear} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth} />
//       </div>
//       <div className="grid grid-cols-1 gap-6">
//         <AnnualCategoryTrendsChart heatmapData={heatmapData} selectedYear={selectedYear} setSelectedYear={setSelectedYear} />
//       </div>
